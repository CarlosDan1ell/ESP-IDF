...
void Task_LED(void *pvParameter){
    ...
    gpio_config(&io_conf); // configura as GPIOs conforme a primeira lista "io_conf"
    ...
    gpio_config(&io_conf2); //configura as GPIOs conforme a primeira lista "io_conf"

    //Ao utilizar gpio_install_isr_service(); todas as interrupções de GPIO de descritor
